...
@Test
public class DetectionManager_0020 extends Common 
{
	...
	public void AddingTransactionAsEvidence() throws Exception 
	{
		...
		System.out.println("----------------------DetectionManager_0020----------------------");
		...
		myDetectionManager_PageObjects.checkTransactionsLowerTabForDetection();
